...
public class Main {
	...
	public static void main(String[] args) {
		double givenSum = 100.0;
		Logic logic = new Logic();
		
		View.printListOfAllTreasures(logic.getListOfTreasures());
		View.printListOfTheMostExpensiveTreasures(logic.getTheMostExpensiveTreasure());
		View.printListOfTreasuresForAGivenSum((logic.getTreasuresForGivenAmount(givenSum)));
	}
